  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless tool rental with Construction Tool Rental, your central supplier with multiple outlets, empowering individual customers in their construction journey."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless tool rental with Construction Tool Rental, your central supplier with multiple outlets, empowering individual customers in their construction journey.`}
            </Text>
            <Box

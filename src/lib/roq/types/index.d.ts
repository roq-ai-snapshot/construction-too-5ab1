...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'order' | 'order_item' | 'product' | 'store' | 'supplier' | 'user';
  ...
  export type storeWhereInput = {
    ...
    opening_hours?: StringFilter<'store'> | string;
    closing_hours?: StringFilter<'store'> | string;
  ...
  export type storeScalarWhereWithAggregatesInput = {
    ...
    opening_hours?: StringWithAggregatesFilter<'store'> | string;
    closing_hours?: StringWithAggregatesFilter<'store'> | string;
